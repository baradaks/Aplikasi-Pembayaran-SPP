		...
		<form method="post" action="update.php">
			...
			<table class="table table-hover text-left text-black align-items-center">
				<tr>			
					<td>Id Kelas</td>
					<td>
						<input type="number" name="id_kelas" class="form-control" value="<?php echo $d['id_kelas']; ?>">
					</td>
				</tr>
				<tr>
					<td>Nama Kelas</td>
					<td><input type="text" name="nama_kelas" class="form-control" value="<?php echo $d['nama_kelas']; ?>"></td>
				</tr>
				<tr>
					<td>Kompetensi Keahlian</td>
					<td><input type="text" name="kompetensi_keahlian" class="form-control" value="<?php echo $d['kompetensi_keahlian']; ?>"></td>
				</tr>
				<tr>
					<td></td>

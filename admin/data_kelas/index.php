        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-2">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <a href="#" class="nav-item nav-link active">Data Kelas</a>
...
<div>
<a href="tambah.php" class="btn btn-primary btn-sm "><i class="fas fa-plus-circle" ></i> TAMBAH KELAS</a>
<p>
<p>
 <table class="table table-hover text-center text-black align-items-center">
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit.php?id_kelas=<?php echo $d['id_kelas']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
					<a href="hapus.php?id_kelas=<?php echo $d['id_kelas']; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
				</td>
			</tr>
			<?php 
		}

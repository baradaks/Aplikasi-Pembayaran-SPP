...
<p>
			<table class="table table-hover text-left text-black align-items-center">
				<tr>			
					<td>Id Petugas</td>
					<td>
						<input type="number" name="id_petugas"class="form-control" value="<?php echo $d['id_petugas']; ?>">
					</td>
				</tr>
				<tr>
					<td>Username</td>
				...
				<tr>
					<td>Nama Petugas</td>
					<td><input type="text" name="nama_petugas"class="form-control" value="<?php echo $d['nama_petugas']; ?>"></td>
				</tr>
				<tr>
					<td>Level</td>
                    ...
                    <option value="Petugas">Petugas</option value="<?php echo $d['level']; ?>"></td>
                </select>
				</tr>
				<tr>
					<td></td>

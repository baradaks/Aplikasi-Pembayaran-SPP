        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-2">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    <a href="../halaman_petugas.php" class="nav-item nav-link">Home</a>
                    <a href="#" class="nav-item nav-link active">Entry Pembayaran</a>
...
<div>
<a href="tambah.php" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle" ></i> TAMBAH PEMBAYARAN</a>
    <input type="text" id="search" class="form-control mt-3 mb-3" placeholder="Search name...">
</div>
<p>
<p>
 <table class="table table- text-center text-black align-items-center">
        <tr class="bg-light">
            <th>No</th>
            <th>Id Pembayaran</th>
            <th>Id Petugas</th>
       ...
       <tbody id="tampil">
        ...
        include 'koneksi.php';
        $no = 1;
        $data = mysqli_query($koneksi,"select * from pembayaran INNER JOIN spp ON pembayaran.id_spp=spp.id_spp");

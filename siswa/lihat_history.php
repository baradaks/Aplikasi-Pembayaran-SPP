...
<div class="container-fluid bg-dark">
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-2">
            <a href="halaman_siswa.php" class="navbar-brand ml-lg-2">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    <a href="history_pembayaran.php" class="nav-item nav-link">Home</a>
                    <a href="history_pembayaran.php" class="nav-item nav-link active">History Pembayaran</a>
                </div>
            </div>
...
<br>
<div class="col-md-12">
<a href="history_pembayaran.php" class="btn btn-primary btn-sm "><i class="fas fa-chevron-circle-left" ></i> Kembali</a>
